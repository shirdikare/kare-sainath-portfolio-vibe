    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        >
          ...
          >
            <Avatar className="w-32 h-32 md:w-40 md:h-40 border-4 border-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 shadow-2xl shadow-cyan-500/25">
              <AvatarImage 
        ...
        <motion.div
          ...
          className="text-2xl md:text-3xl font-medium mb-8 text-gray-200 h-12 flex items-center justify-center"
        >
